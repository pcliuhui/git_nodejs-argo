...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'idx.pcbh.dpdns.org';          // 固定隧道域名,留空即启用临时隧道
...
const ARGO_PORT = process.env.ARGO_PORT || 28882;            // 固定隧道端口,使用token需在cloudflare后台设置和这里一致
